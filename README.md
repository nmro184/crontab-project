...
1. **Expression Validation**: The program checks if the crontab expression is valid based on the allowed inputs.
2. **Natural Language Translation**: Converts valid crontab expressions into a readable, natural language description.
...
1. **Input a Crontab Expression**: Enter a crontab expression following the allowed input rules.
2. **Receive Translation**: The program will validate the expression and provide a natural language translation if it is valid.
